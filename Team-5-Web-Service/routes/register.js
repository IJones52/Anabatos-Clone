...
router.post('/', (request, response) => {
    ...
    if(isStringProvided(first) 
        ...
        let theQuery = "INSERT INTO MEMBERS(FirstName, LastName, Username, Email, Password, Salt, Verification, Verified, Nickname) VALUES ($1, $2, $3, $4, $5, $6, $7, $8, $9) RETURNING Email"
        let verificationStr = randString()
        let verifiedValue = false
        let values = [first, last, username, email, salted_hash, salt, verificationStr, verifiedValue, nickname]
        
        pool.query(theQuery, values)
            .then(result => {
                
                sendMail(email, verificationStr)
...
const sendMail = (email, str) => {
    ...
    mailOptions = {
        ...
        html: `Click this <a href=https://team-5-tcss-450.herokuapp.com/verification/${str}> link </a> to verify your email.`
    }
