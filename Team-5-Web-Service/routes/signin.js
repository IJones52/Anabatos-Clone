...
router.get('/', (request, response, next) => {
    ...
    const theQuery = "SELECT Password, Salt, MemberId,Firstname, Lastname, Nickname, Verified FROM Members WHERE Email=$1"
    ...
    pool.query(theQuery, values)
        .then(result => { 
            ...
            if (storedSaltedHash === providedSaltedHash ) {
                //If they're not verified tell them to get verified
