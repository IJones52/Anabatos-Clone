...
CREATE TABLE Requests(PrimaryKey SERIAL PRIMARY KEY,
...
/*ALTER TABLE Members ALTER COLUMN Verification TYPE VARCHAR(255);
ALTER TABLE MEMBERS ADD Verified BOOLEAN;*/
/*ALTER TABLE Members ADD Nickname VARCHAR(255);*/